...
with lib.nebula; let
  ...
  '';
  vesktop-settings-settings_json = ''
    {
...
in {
  ...
  config = mkIf cfg.enable {
    ...
    systemd.tmpfiles.settings = {
      "10-vesktopshiz" = {
        "/home/kinzoku/.config/discord/settings.json" = {
          "w+" = {
            user = "kinzoku";
            group = "users";
            mode = "0755";
            argument = "${discord-settings_json}";
          };
        };
        "/home/kinzoku/.config/vesktop/settings.json" = {
          "w+" = {
            user = "kinzoku";
            group = "users";
            mode = "0755";
            argument = "${vesktop-settings_json}";
          };
        };
        "/home/kinzoku/.config/vesktop/settings/settings.json" = {
          "w+" = {
            user = "kinzoku";
            group = "users";
            mode = "0755";
            argument = "${vesktop-settings-settings_json}";
          };
        };
      };
    };
